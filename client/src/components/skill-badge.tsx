...
const skillConfig = {
  logic: { icon: Brain, label: "Logic", color: "bg-[hsl(245_70%_55%)] text-white" },
  creative: { icon: Palette, label: "Creative", color: "bg-[hsl(280_60%_55%)] text-white" },
  technical: { icon: Code, label: "Technical", color: "bg-[hsl(155_65%_45%)] text-white" },
  communication: { icon: MessageCircle, label: "Communication", color: "bg-[hsl(35_80%_55%)] text-white" },
};
